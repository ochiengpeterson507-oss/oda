    ...
    >
      <form onSubmit={handleLogin} className="space-y-10 group-hooks">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <label className="text-[11px] font-bold uppercase tracking-[0.2em] text-coffee/50">Access Token</label>
              <Link to="#" className="text-[10px] font-bold uppercase tracking-widest text-coffee/30 hover:text-coffee transition-colors">Recover</Link>
            </div>
            <div className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-stone/40 group-focus-within:text-coffee transition-colors">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-stone/40 hover:text-coffee transition-colors"
        ...
        <div className="space-y-8">
          <button 
            type="submit" 
            disabled={loading}
            className="btn-primary w-full py-4 text-xs font-bold uppercase tracking-[0.3em] disabled:opacity-50"
          >
      ...
      <div className="pt-12 text-center">
        <p className="text-[11px] font-medium text-stone/40 mb-4">
          Unregistered Corporate Entity?
        </p>
        <Link to="/signup" className="text-xs font-bold text-coffee uppercase tracking-[0.2em] hover:text-olive transition-colors">
          Initialize Registration
        </Link>
      </div>

      <div className="mt-20 pt-8 border-t border-sand flex justify-between items-center opacity-40">
        <span className="text-[9px] font-bold uppercase tracking-widest text-coffee">ISO 27001 CLOUD</span>
        <span className="text-[9px] font-bold uppercase tracking-widest text-coffee">ODA HUB</span>
      </div>
    </AuthLayout>
  );
}
